  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Padding(
          padding:  EdgeInsetsDirectional.only(start: 15.0.h),
          child: Container(
        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: MediaQuery.sizeOf(context).height * 0.088.h),
                Text(
                  'Sign In',
                  style: TextStyle(
                ...
                BlocListener<AuthViewModel, AuthStates>(
                  ...
                  child: CustomElevatedButton(text: "Sign In", onPressed: login),
                ),
